<?php include_once 'debutNav.inc.php'; ?>

<div class="container">
    <!-- formulaire de redirection -->
    <form action="navigation.traitement.php" method="POST"> 
        <div class="row">
            <div class="col-lg-offset-5 col-lg-3 col-md-offset-5 col-md-3 col-sm-offset-4 col-sm-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-offset-9 col-lg-3 col-md-offset-9 col-md-3 col-sm-offset-8 col-sm-3">
                <button type="submit" class="btn btn-primary btn-lg animated bounceInLeft" name="diplomes" id="diplomes">Diplômes</button>
            </div>        
        </div>

        <div class="row">  
            <img id="portrait" class="img-responsive center-block animated rotateIn" src="../projetCV/bootstrap/img/caro (2).png" alt="photo de Caroline Grimault">
        </div>
        ...
        <div class="row">
            <div class="col-lg-offset-5 col-lg-3 col-md-offset-4 col-md-3 col-sm-offset-3 col-sm-3">
